...
The current milestone exposes modular Tools and Resources facades plus Multi Round-Trip
Requests. Resources supports static lists, URI templates and reads. Complete tool
...
Prompts, subscriptions, Tasks, Streamable HTTP, HTTP header routing,
